...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/storage/css/jquery-ui.css">
    <link rel="stylesheet" href="/storage/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/storage/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="/storage/css/bootstrap-datepicker.css">
    ...
    <link rel="stylesheet" href="/storage/fonts/flaticon/font/flaticon.css">
  
    <link rel="stylesheet" href="/storage/css/aos.css">
  ...
  <div class="site-wrap">
        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="/">Sunrise</a></h2>
              </div>
              <div class="col-10">
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(storage/images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              
              <h1 class="mb-2">Welcome To Sunrise</h1>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(storage/images/hero_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(storage/images/hero_3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
        ...
        <div class="row">
          ...
          <!-- <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="storage/images/img_3.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
          ...
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                  ...
                  <img src="storage/images/img_2.jpg" alt="" class="img-fluid">
                </a>
              </div>

              <img src="storage/images/img_1.jpg" alt="Image" class="img-fluid image-absolute">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5">DỊCH VỤ KHÁCH SẠN</h2>
          </div>
        </div>
        <div class="row">
    ...
    <div class="py-5 upcoming-events" style="background-image: url('storage/images/hero_1.jpg'); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="col-md-6 col-lg-3">
            <a href="images/img_1.jpg" class="image-popup img-opacity"><img src="storage/images/img_1.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_2.jpg" class="image-popup img-opacity"><img src="storage/images/img_2.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_3.jpg" class="image-popup img-opacity"><img src="storage/images/img_3.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_4.jpg" class="image-popup img-opacity"><img src="storage/images/img_4.jpg" alt="Image" class="img-fluid"></a>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <a href="images/img_5.jpg" class="image-popup img-opacity"><img src="storage/images/img_5.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_6.jpg" class="image-popup img-opacity"><img src="storage/images/img_6.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_7.jpg" class="image-popup img-opacity"><img src="storage/images/img_7.jpg" alt="Image" class="img-fluid"></a>
          </div>
      ...
      <div class="container">
        ...
        <div class="nonloop-block-15 owl-carousel">
            ...
            <div class="media-with-text p-md-5">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="storage/images/img_1.jpg" alt="" class="img-fluid">
                </a>
              </div>
            ...
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="storage/images/img_3.jpg" alt="" class="img-fluid">
                </a>
              </div>
              <h2 class="heading mb-0"><a href="#">Lorem Ipsum Dolor Sit Amet</a></h2>
              <span class="mb-3 d-block post-date">Dec 20th, 2020 &bullet; By <a href="#">Admin</a></span>
      ...
      <div class="container">
        ...
        <div class="nonloop-block-14 owl-carousel">
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="storage/images/person_1.jpg" alt="Image" class="img-fluid rounded">
              </div>
              <div>
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="storage/images/person_2.jpg" alt="Image" class="img-fluid rounded">
              </div>
              <div>
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="storage/images/person_3.jpg" alt="Image" class="img-fluid rounded">
              </div>
              <div>
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="storage/images/person_4.jpg" alt="Image" class="img-fluid rounded">
              </div>
              <div>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy; <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All Rights Reserved | This template is made with <i class="icon-heart text-primary" aria-hidden="true"></i> by <a href="" target="_blank" >CodeGym</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
  ...
  <script src="storage/js/jquery-migrate-3.0.1.min.js"></script>
  ...
  <script src="storage/js/jquery.stellar.min.js"></script>
  <script src="storage/js/jquery.countdown.min.js"></script>
  <script src="storage/js/jquery.magnific-popup.min.js"></script>
  <script src="storage/js/bootstrap-datepicker.min.js"></script>
  <script src="storage/js/aos.js"></script>

  
  <script src="storage/js/mediaelement-and-player.min.js"></script>
